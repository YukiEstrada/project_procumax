...
@section('title', 'Approval Level 1')
                                    ...
                                    <div class="tab-pane fade show active" id="detail" role="tabpanel" aria-labelledby="custom-tabs-four-formPo-tab">
                                        <form action="#" method="#">
                                            ...
                                            <div class="form-row">                                                
                                                ...
                                                <div class="col-md-3 mb-2"> 
                                                    <label class="align-self-center">Level 2</label>                                                                                                       
                                                ...
                                                <div class="col-md-4 mb-2 text-right">    
                                                    <button class="btn btn-danger" name="submit" type="button" data-toggle="modal" data-target="#rejectLvl1">Reject</button>                                                                                                                                                                                                                  
                                                    <button class="btn btn-primary" name="submit" type="button" data-toggle="modal" data-target="#approveLvl1">Approve</button>                                                                                                                   
                                                </div>    
                                                <!-- Modal Reject -->
                                                <div style="text-align: center" class="modal fade" id="rejectLvl1" tabindex="-1" role="dialog" aria-labelledby="rejectLvl1Title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            <h5 class="modal-title" id="rejectLvl1LongTitle">Reject Level 1</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                            </div>
                                                            <div class="modal-body">
                                                            Are you sure to reject this level 1?
                                                            </div>
                                                ...
                                                <!-- Modal Approve -->
                                                <div style="text-align: center" class="modal fade" id="approveLvl1" tabindex="-1" role="dialog" aria-labelledby="approveLvl1Title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            <h5 class="modal-title" id="approveLvl1LongTitle">Approve Level 1</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                            </div>
                                                            <div class="modal-body">
                                                            Are you sure to approve this level 1?
                                                            </div>
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            <button name="submit" type="submit" class="btn btn-primary">Yes</button>
