...
@section('title', 'Approval Level 3')
                                        ...
                                        <form action="#" method="#">
                                            ...
                                            <div class="form-row">                                                
                                                ...
                                                <div class="col-md-4 mb-2 text-right">    
                                                    <button class="btn btn-danger" name="submit" type="button" data-toggle="modal" data-target="#rejectLvl3">Reject</button>                                                                                                                                                                                                                  
                                                    <button class="btn btn-primary" name="submit" type="button" data-toggle="modal" data-target="#approveLvl3">Approve</button> 
                                                </div>  
                                                <!-- Modal Reject -->
                                                <div style="text-align: center" class="modal fade" id="rejectLvl3" tabindex="-1" role="dialog" aria-labelledby="rejectLvl3Title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            <h5 class="modal-title" id="rejectLvl3LongTitle">Reject Level 3</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                            </div>
                                                            <div class="modal-body">
                                                            Are you sure to reject this level 3?
                                                            </div>
                                                ...
                                                <!-- Modal Approve -->
                                                <div style="text-align: center" class="modal fade" id="approveLvl3" tabindex="-1" role="dialog" aria-labelledby="approveLvl3Title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            <h5 class="modal-title" id="approveLvl3LongTitle">Approve Level 3</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                            </div>
                                                            <div class="modal-body">
                                                            Are you sure to approve this level 3?
                                                            </div>
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            <button name="submit" type="submit" class="btn btn-primary">Yes</button>
